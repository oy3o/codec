...
func (c *Fixed[Payload, E]) MarshalBinary() ([]byte, error) {
	var e E
	buf := make([]byte, c.Size())
	if _, err := binary.Encode(buf, e.ByteOrder(), &c.Payload); err != nil {
...
func (c *Fixed[Payload, E]) UnmarshalBinary(data []byte) error {
	var e E
	n, err := binary.Decode(data, e.ByteOrder(), &c.Payload)
	if err != nil {
...
func (c *Fixed[Payload, E]) ReadFrom(r io.Reader) (int64, error) {
	var e E
	err := binary.Read(r, e.ByteOrder(), &c.Payload)
	if err != nil {
		return 0, err
	}
...
func (c *Fixed[Payload, E]) WriteTo(w io.Writer) (int64, error) {
	var e E
	err := binary.Write(w, e.ByteOrder(), &c.Payload)
	if err != nil {
		return 0, err
	}
	return int64(c.Size()), nil
...
func (c *Fixed[Payload, E]) MarshalTo(p []byte) (int, error) {
	var e E
	n, err := binary.Encode(p, e.ByteOrder(), &c.Payload)
	if err != nil {
